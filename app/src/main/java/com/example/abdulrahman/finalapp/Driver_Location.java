...
public class Driver_Location extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driver__location);
...
//        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.driver__location, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_joinCircle) {
            Intent intent=new Intent(Driver_Location.this,JoinCircle.class);
            startActivity(intent);
        } else if (id == R.id.nav_logout) {
            Intent intent = new Intent(Driver_Location.this, MainActivity.class);
    ...
    public void onLocationChanged(final Location location) {
        ...
        database.child("users").child("drivers").child("driversAvailable").child(name).addValueEventListener(new ValueEventListener() {
            @Override
